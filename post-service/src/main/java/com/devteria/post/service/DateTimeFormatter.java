...
public class DateTimeFormatter {
    ...
    private String formatInDate(Instant instant) {
        ...
        java.time.format.DateTimeFormatter dateTimeFormatter = java.time.format.DateTimeFormatter.ISO_DATE; //ISO_DATE: yyyy-MM-dd
