...
public class PostService {
    ...
    public PageResponse<PostResponse> getMyPosts(int page, int size){
        ...
        try {
            userProfile = profileClient.getUserProfile(userId).getResult(); //getResult() sẽ lấy về object UserProfileResponse
        } catch (Exception e) {
        ...
        //Take username from userProfile from ProfileClient from profile-service
